...
function copesa_gutenberg_block_infography_cgb_block_assets() {
	// Styles.
	wp_enqueue_style(
		'copesa_gutenberg_block_infography-cgb-style-css', // Handle.
		plugins_url( 'dist/blocks.style.build.css', dirname( __FILE__ ) ), // Block style CSS.
		array( 'wp-blocks' ) // Dependency to include the CSS after it.
		// filemtime( plugin_dir_path( __DIR__ ) . 'dist/blocks.style.build.css' ) // Version: filemtime — Gets file modification time.
	);
} // End function copesa_gutenberg_block_infography_cgb_block_assets().
...
function copesa_gutenberg_block_infography_cgb_editor_assets() {
	// Scripts.
	wp_enqueue_script(
		'copesa_gutenberg_block_infography-cgb-block-js', // Handle.
